...
final class CommentReactionsView: UIStackView {

    final class CommentReactionsView: UIStackView {
        
        private let commentButton: UIButton = {
            let button = UIButton()
            button.setImage(UIImage(named: "detail_comment"), for: .normal)
            return button
        }()
        
        private let likeButton: UIButton = {
            let button = UIButton()
            button.setImage(UIImage(named: "detail_comment_like"), for: .normal)
            return button
        }()
        
        private let moreButton: UIButton = {
            let button = UIButton()
            button.setImage(UIImage(named: "detail_comment_more"), for: .normal)
            return button
        }()
