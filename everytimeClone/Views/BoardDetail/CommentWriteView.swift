...
final class CommentWriteView: UIView {
    ...
    private let nicknameButton: UIButton = {
        ...
        button.setImage(UIImage(named: "comment_hide_nickname_icon"), for: .normal)
    ...
    private let sendButton: UIButton = {
        let button = UIButton()
        button.setImage(UIImage(named: "comment_send_icon"), for: .normal)
        button.imageView?.contentMode = .scaleAspectFit
        return button
    }()
...
// 댓글 입력 시 placeholder 삭제
extension CommentWriteView: UITextViewDelegate {
